...
class _DoctorRegistrationPageState extends State<DoctorRegistration>{
      ...
      backgroundColor: CompanyStyle.primaryColor,
        title:  Row(
          children: [
            ...
            Container(
                padding: const EdgeInsets.all(10.0), child: Text('Doctor Registration'))
          ],
...
class RegistrationFormState extends State<RegistrationForm> {
  ...
  final List<String> bloodGroupItems = <String>["O+", "O-", "A+","A-","B+","B-","AB+","AB-"];
  final List<String> maritalStatusItems = <String>["Single", "Married", "Divorce","Widow"];
  final List<String> practicingAsItems = <String>["Doctor", "Practitioner", "Therapist","Assistant","Internship","Scholarship","Thesis","Organic Farmer","Scientist","Promoter"];
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                     ...
                     decoration: InputDecoration(
                      ...
                      //     fontSize: 20,
                      //   ),
                      //   validator: (value)=>value==null?'Please select practicing':null,
                      //   dropdownColor: CompanyStyle.primaryColor,
                      //   elevation :9,
                      //   // value: selected,
                      //   items: practicingAsItems.map((label) => DropdownMenuItem(
                    ...
                    CheckboxListTile(
                      ...
                      title: new Text('I Accept Terms & Conditions *', style: TextStyle(fontSize: 14.0,color: Colors.blue),),
                      ...
                      ElevatedButton(
                        ...
                        child: Container(
                          ...
                          child: Text('Create Account & Next', style: TextStyle(fontSize: screenWidth/25,letterSpacing: 2),),
                        ...
                        onPressed: isDataProcessed?null:() {
                          ...
                          docRegForm={
                            ...
                            'tncAcceptedFlag':tncAcceptedFlag.text,
                          ...
                          if (_formKey.currentState.validate() && isTncChecked) {
                            ...
                            createDocotrAccount(docRegForm);
                          }else{
...
Widget buildTherapyField(List<AmpamtTherapiesModel> ampamtTherapiesModelList){
  return MultiSelectDialogField(
      ...
      validator: (value)=>value==null?'Please select At Least One practicing':null,
  ...
  createDocotrAccount(Map<String, dynamic> docRegForm) async{
    ...
    try {
      final response = await _provider.post("/account/create-doctor-account", docRegForm);
    ...
    if (response2 != null) {
      ...
      else if (response2.status!=null && response2.status == CommonConstant.STATUS_SUCCESS) {
  ...
  // static showSnackBar(BuildContext context,String msg,Color bgcolor,Color txtColor){
