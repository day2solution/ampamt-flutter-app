...
class MyEvent extends StatefulWidget {
  ...
  MyEvent({this.accountId}) : super();
  @override
  _MyEventState createState() => _MyEventState(accountId: accountId);
}

class _MyEventState extends State<MyEvent> {
  final String accountId;
  _MyEventState({this.accountId}) : super();
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text('My Events',  style: TextStyle(fontSize: screenWidth/20,fontWeight: FontWeight.bold),),
                          ],
                        ),
                      ],
                    ),
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        ...
                        onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>AddEvent(accountId: accountId)));
                        },
                      )
                    ],
                  ),
